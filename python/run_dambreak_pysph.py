...
# set body force
solver.set_acceleration(b,1000)
...
solver.activate_artificial_viscosity(True,0.1)

# run simulation
output_name = "dambreak_pysph"
...
try:
    ...
    solver.run(1001, vtk_freq=100, log_freq=100)
finally:
    os.chdir(cwd)